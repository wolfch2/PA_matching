...
import geopandas as gpd # open tries to load entire geometry into a col. I think... very slow and memory intensive
import pandas as pd
import fiona
import shapely
import rasterio
...
import math
import affine
import multiprocess # https://stackoverflow.com/questions/34618301/python-multiprocessing-using-pickle-kwargs-and-function-references
import glob
import functools
import operator
