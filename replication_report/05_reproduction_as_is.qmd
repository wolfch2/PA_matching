...
```{r}
range_maps_s3 <- my_files %>%
  filter(str_detect(Key, "/range_maps/")) %>%
  pluck("Key")
range_maps_local <- str_remove(range_maps_s3, "Replication_wolf/")
map2(range_maps_s3, range_maps_local, save_from_s3)
```
