...
# Need to specify the DataFrame in csv 
replace_all(pattern = "PA_df = CSV.read(\"data_processed/PAs_tab.csv\")", 
            replacement = "PA_df = CSV.read(\"data_processed/PAs_tab.csv\", DataFrame)",
            file = matching_script)
